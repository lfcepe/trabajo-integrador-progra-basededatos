...
urlpatterns = [
    ...
    path("index_categorias/display_iva/edit_iva/<int:id>/", views.edit_iva, "edit_iva"),
    ...
    path("index_categorias/display_iva/delete_iva/<int:id>/", views.delete_iva, "delete_iva"),
